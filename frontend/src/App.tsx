  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/people/:personId" element={<ProtectedRoute><PersonPhotosPage /></ProtectedRoute>} />
          ...
          element={
            <div className="flex min-h-screen items-center justify-center bg-gray-50 dark:bg-gray-950">
              <div className="text-center">
                ...
                <a href="/photos" className="mt-4 inline-block text-sm text-accent hover:text-accent-hover">
                  Go to Photos
                </a>
              </div>
            </div>
